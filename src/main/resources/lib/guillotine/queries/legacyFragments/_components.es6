...
const {
    productTargetMixin,
} = require('/lib/guillotine/queries/legacyFragments/dangerous-mixins/product-target-mixin');
const {
    calculatorTargetMixin,
} = require('/lib/guillotine/queries/legacyFragments/dangerous-mixins/calculator-target-mixin');
