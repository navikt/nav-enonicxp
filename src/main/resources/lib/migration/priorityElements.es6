...
const formImport = [
    {
        ...
        'description': 'Unemployment benefit is intended to partially compensate for your loss of income when you become unemployed. In order to become eligible for unemployment benefit, you must first register as a job seeker at NAV.',
        'url': 'https://www.nav.no/soknader/en/person/arbeid/dagpenger',
        'language': 'en',
        'keywords': ['NAV 04-01.03', 'NAV 04-01.04', 'NAV 04-16.03', 'NAV 04-16.04', 'NAV 04-02.05', 'NAV 04-08.03', 'NAV 04-13.01'],
    },
    {
        'displayName': 'Dagpenger',
        'description': 'For å få dagpenger må du først være registrert som arbeidssøker hos NAV. Du kan også ha krav på dagpenger hvis du er permittert, hvis arbeidsgiveren din er konkurs, hvis du nettopp har avsluttet verneplikt eller siviltjeneste, eller hvis du har vært skoleelev eller student og har hatt jobb ved siden av.',
    ...
    },
    {
        ...
        'description': 'You use this form when you are applying for compensation for loss of income due to unemployment, but not because you are laid off. NB: You must be registered as a job seeker first. If you are not registered, you can register here (Norwegian only).',
    ...
    },
    {
        ...
        'description': 'You use this form when you are applying for compensation for loss of income because you are laid off. NB: You must be registered as a job seeker first. If you are not registered, you can register here (Norwegian only).',
    ...
    },
    {
        ...
        'url': 'https://www.nav.no/soknader/nb/person/arbeid/dagpenger#NAV040803',
        'language': 'nb',
    },
    {
        'displayName': 'Personal statement regarding cross border worker status - NAV 04-13.01',
        'description': 'This form is used if you are an EEA commuter who works in a fixed rotation / rotation scheme in Norway and who travels home during your free periods.',
        'url': 'https://www.nav.no/soknader/en/person/arbeid/dagpenger#NAV041301',
        'language': 'en',
    },
    {
        'displayName': 'Egenerklæringsskjema for fastsettelse av grensearbeiderstatus - NAV 04-13.01',
        'description': 'Dette skjemaet benyttes dersom du er EØS-pendler som arbeider i en fast turnus/rotasjonsordning i Norge, og som reiser hjem i dine friperioder.',
        'url': 'https://www.nav.no/soknader/nb/person/arbeid/dagpenger#NAV041301',
        'language': 'nb',
    },
    {
    ...
    },
    {
        ...
        'description': 'Gjelder kun hvis du har vedtak om rett til å få dekket utgiftene til bruk av egen bil. Du skal oppgi antall dager og dokumenterte parkeringsutgifter.',
    ...
    },
    {
        ...
        'description': 'Som hovedregel har du ikke rett til dagpenger hvis du er skoleelev eller student, men det er noen unntak. Dersom du ønsker å beholde dagpenger mens du er skoleelev, må du søke om dette.',
        'url': 'https://www.nav.no/soknader/nb/person/arbeid/Bistand-fra-NAV-for-a-komme-i-arbeid#NAV040605',
        'language': 'nb',
    },
    {
        'displayName': 'Registreringsskjema for tilskudd til utdanning NAV 76-07.10 - NAV 76-07.10',
        'description': 'Jeg mottar dagpenger, og ønsker kurs eller utdanning\n\nSom hovedregel har du ikke rett til dagpenger hvis du er skoleelev eller student, men det er noen unntak. Dersom du ønsker å beholde dagpenger mens du er skoleelev, må du søke om dette.',
        'url': 'https://www.nav.no/soknader/nb/person/arbeid/Bistand-fra-NAV-for-a-komme-i-arbeid#NAV760710',
        'language': 'nb',
    },
    {
        'displayName': 'Oppfølging bistand - NAV 00-01.00',
        'description': 'Oppfølging i forbindelse med bistand fra NAV\n\nDersom du allerede er i dialog med NAV og skal sende inn kjøreliste, legeerklæring, jobblogg eller annen dokumentasjon i forbindelse med oppfølging, velger du lenken under her og går videre.',
        'url': 'https://www.nav.no/soknader/nb/person/arbeid/Bistand-fra-NAV-for-a-komme-i-arbeid#NAV000100',
        'language': 'nb',
    },
    {
    ...
    },
    {
        ...
        'description': 'Dersom du allerede mottar arbeidsavklaringspenger, kan du søke om å beholde disse under etablering av egen virksomhet i en oppstartsfase inntil 3 måneder. Du må søke før bedriften har startet opp (må være ny virksomhet).',
        'url': 'https://www.nav.no/soknader/nb/person/arbeid/starte-egen-bedrift#NAV111309',
        'language': 'nb',
    },
    {
        'displayName': 'Søknad om utstedelse av attest PD U2 - NAV 04-02.01',
        'description': 'Dersom du allerede mottar dagpenger, kan du søke om å få beholde dagpengene i inntil tre måneder mens du søker arbeid i et annet eøs-land. Du må ha mottatt dagpenger i Norge i minst fire uker før du søker.',
    ...
    },
    {
        ...
        'description': 'For at du skal kunne søke om lønnsgaranti, må arbeidsgiveren din være konkurs. Du kan sjekke om arbeidsgiveren din er konkurs på Brønnøysundregistrene. Oppgi virksomhetens navn eller organisasjonsnummer. Her kan du også finne opplysninger om hvem som er bostyrer. Du kan eventuelt kontakte tingretten for å få disse opplysningene.\n\nDersom arbeidsgiveren din er konkurs og du ikke har fått deg ny jobb, må du være registrert som arbeidssøker hos NAV for å søke om dagpenger.\n\nDu må sende skjemaet med eventuelle vedlegg direkte til bostyrer.',
        'url': 'https://www.nav.no/soknader/nb/person/arbeid/lonnsgaranti-arbeidsgiver-betaler-ikke-ut-lonn#NAV670101',
        'language': 'nb',
    },
    {
        'displayName': 'Application for work assessment allowance - NAV 11-13.05',
        'description': 'You can apply for AAP if you need medical treatment or measures to help you get back to work. AAP ensures that you have income during periods when you, due to illness or injury, need help from NAV to get back to work.\n\nNB! You must first register as unemployed before you can apply for a work clarification allowance.',
        'url': 'https://www.nav.no/soknader/en/person/arbeid/arbeidsavklaringspenger#NAV111305',
        'language': 'en',
    },
    {
        'displayName': 'Søknad om arbeidsavklaringspenger - NAV 11-13.05',
        'description': 'Du kan søke om AAP dersom du har behov for medisinsk behandling eller tiltak som skal hjelpe deg tilbake i arbeid. AAP skal sikre deg inntekt i perioder hvor du, på grunn av sykdom eller skade, har behov for hjelp fra NAV for å komme i arbeid.\n\nOBS! Du må først registrere deg som arbeidssøker før du kan søke om arbeidsavklaringspenger. ',
    ...
    },
    {
        ...
        'description': 'Bruk lenken nedenfor hvis du enten mottar tilleggsstønader og skal sende inn kjøreliste, eller hvis du mottar arbeidsavklaringspenger og skal sende inn annen dokumentasjon for å følge opp saken din.\n\nDisse vedleggene bruker du i forbindelse med arbeidsavklaringspenger.',
    ...
    },
    {
        ...
        'description': 'Gjelder kun dersom du har varige problemer med å bruke offentlig transport til arbeid eller arbeidsrettet utdanning, og er avhengig av annen transport.\n\nMottar du arbeidsavklaringspenger eller tiltakspenger og deltar i arbeidsrettet tiltak skal du benytte skjema for tilleggsstønader.',
        'url': 'https://www.nav.no/soknader/nb/person/hjelpemidler-og-tilrettelegging/arbeids-og-utdanningsreiser#NAV100042',
        'language': 'nb',
    },
    {
        'displayName': 'Bytte av hjelpemiddel - NAV 10-07.31',
        'description': 'Du kan kun bytte til et tilsvarende hjelpemiddel. Hvis hjelpemiddelet ditt er utslitt eller noe er ødelagt, må du selv kontakte kommunal servicetekniker for å få en vurdering før du kan be om bytte. Trenger du et annet hjelpemiddel må du søke på nytt. Er du i tvil om du skal bytte eller søke kan du kontakte hjelpemiddelsentralen der du bor.',
    ...
    },
    {
        ...
        'description': 'Jeg vil søke om refusjon av reiseutgifter fordi jeg har fått tilpasset ny bil.\n\nDu kan også bruke denne søknaden dersom spesialutstyret er blitt reparert. For refusjon av reiser til sykehus og andre tjenester som administreres av helseforetakene, gå til www.pasientreiser.no',
    ...
    {
        'displayName': 'Søknad om hjelpemidler (hørsel) - NAV 10-07.03',
    ...
    },
    {
        ...
        'description': 'Jeg vil søke om stønad til tilpasningskurs for syns- og hørselshemmede eller til opphold på folkehøyskole. Du må spesifisere hvilke kurs du søker stønad til.\n\n',
        'url': 'https://www.nav.no/soknader/nb/person/hjelpemidler-og-tilrettelegging/horsel#NAV100718',
        'language': 'nb',
    },
    {
        'displayName': 'Søknad om hjelpemidler PC eller nettbrett - NAV 10-07.03',
        'description': 'Jeg vil søke om tilskudd til PC eller nettbrett. Du må gå på grunnskolen og ha spesifikke lese- og skrivevansker. Skolen din må dokumentere at PC eller nettbrett er en del av det pedagogiske opplegget ved skolen.Du kan også bruke dette skjemaet ved søknad om program for lese- og skrivestøtte.\n\n ',
        'url': 'https://www.nav.no/soknader/nb/person/hjelpemidler-og-tilrettelegging/kommunikasjon-og-kognisjon#NAV100703',
        'language': 'nb',
    },
    {
        'displayName': 'Søknad om hjelpemidler ved kognitiv funksjonsnedsettelse - NAV 10-07.03',
        'description': 'Jeg vil søke om hjelpemidler fordi jeg har kognitive vansker.',
        'url': 'https://www.nav.no/soknader/nb/person/hjelpemidler-og-tilrettelegging/kommunikasjon-og-kognisjon#NAV100703',
        'language': 'nb',
    },
    {
        'displayName': 'Søknad om hjelpemidler til kommunikasjon - NAV 10-07.03',
        'description': 'Jeg vil søke om hjelpemidler fordi jeg har språk- eller talevansker.',
        'url': 'https://www.nav.no/soknader/nb/person/hjelpemidler-og-tilrettelegging/kommunikasjon-og-kognisjon#NAV100703',
        'language': 'nb',
    },
    {
        'displayName': 'Hjelp til vurdering og utprøving (kommunikasjon og kognisjon) - NAV 10-07.20',
        'description': 'Jeg trenger hjelp til vurdering og utprøving av hjelpemidler. \n\nHvis du vet hva du vil søke om, bruker du i stedet skjema NAV 10-07.03.',
    ...
    },
    {
        ...
        'description': 'Gjelder kun hvis du skal søke om protese, ortose, fotseng eller ortopedisk fottøy. Skjemaet fylles ut av legespesialist eller sykehuslege.\n\nLes mer om ortopediske hjelpemidler',
    ...
    },
    {
        ...
        'description': 'Jeg vil søke om refusjon av reiseutgifter knyttet til ortopediske hjelpemidler m.m.\n\nGjelder kun ved reise i forbindelse kurs, utprøving og tilpasning av protese, ortose, spesialsko, fotseng, brystprotese, ansiktsdefekprotese, øyeprotese, parykk, høreapparat, tilpasningskurs, folkehøyskole eller grunnmønster.\n\nFor refusjon av reiser til sykehus og andre tjenester som administreres av helseforetakene, gå til www.pasientreiser.no',
        'url': 'https://www.nav.no/soknader/nb/person/hjelpemidler-og-tilrettelegging/ortopediske-hjelpemidler#NAV100716',
        'language': 'nb',
    },
    {
        'displayName': 'Søknad om hjelpemidler (syn) - NAV 10-07.03',
    ...
    {
        'displayName': 'Hjelp til vurdering og utprøving (syn) - NAV 10-07.20',
        'description': 'Jeg trenger hjelp til vurdering og utprøving av hjelpemidler. \n\nHvis du vet hva du vil søke om, bruker du i stedet skjema NAV 10-07.03.',
    ...
    },
    {
        ...
        'description': 'Gjelder kun personer som er avhengig av å få hjelp til praktiske gjøremål.\n\nLes mer om vilkårene og kriterier for tildeling av servicehund',
    ...
    },
    {
        ...
        'description': 'Jeg vil søke om refusjon av reiseutgifter fordi jeg har fått tilpasset hjelpemidler. For refusjon av reiser til sykehus og andre tjenester som administreres av helseforetakene, gå til www.pasientreiser.no.',
    ...
    {
        'displayName': 'Seksualteknisk hjelpemiddel - NAV 10-06.06',
        'description': 'Bestilling av seksualteknisk hjelpemiddel. \n\nBestillingen gjøres av legen, som \n\nsender side 2 i skjemaet pr. post til leverandøren.\n\nsender side 3 i skjemaet pr. post til NAV Økonomitjeneste, Helseoppgjør, 6863 Leikanger, Norge \n\nDu vil finne mer informasjon om seksualtekniske hjelpemidler her. ',
        'url': 'https://www.nav.no/soknader/nb/person/hjelpemidler-og-tilrettelegging/seksualteknisk-hjelpemiddel#NAV100606',
        'language': 'nb',
    },
    {
        'displayName': 'Søknad om hjelpemidler PC eller nettbrett - NAV 10-07.03',
    ...
    {
        'displayName': 'Fullmakt i forbindelse med søknad om hjelpemidler - NAV 10-07.04',
        'description': 'Skjemaet benyttes når søker gir fullmakt til at søknad kan hentes fra nav.no og fylles ut av behandler/kartlegger i etterkant av kartlegging.',
        'url': 'https://www.nav.no/soknader/nb/person/hjelpemidler-og-tilrettelegging/diverse#NAV100704',
        'language': 'nb',
    },
    {
        'displayName': 'Søknad om stønad til tilpasningskurs - NAV 10-07.18',
    ...
    },
    {
        ...
        'description': 'Gjelder kun hvis du må ha spesialsydde klær.\n\nLes mer om stønad til grunnmønster og spesialsøm',
        'url': 'https://www.nav.no/soknader/nb/person/hjelpemidler-og-tilrettelegging/diverse#NAV100755',
        'language': 'nb',
    },
    {
        'displayName': 'Innlevering av tekniske hjelpemidler - NAV 10-07.63',
        'description': 'Jeg vil levere inn tekniske hjelpemidler.\n\nLast ned skjema for innlevering av hjelpemidler. ',
        'url': 'https://www.nav.no/soknader/nb/person/hjelpemidler-og-tilrettelegging/diverse#NAV100763',
        'language': 'nb',
    },
    {
    ...
    {
        'displayName': 'Report on occupational injury / personal injury sustained in the course of duties on board ship or during fishing/catching - NAV 13-07.08',
        'description': 'You use this form when you want to report an injury or disease which has occurred during duties on board ship or during fishing/ hunting at sea',
    ...
    },
    {
        ...
        'description': 'Jeg vil søke om frivillig trygdeordning for å få rett til særytelser på grunn av yrkesskade.\n\nDette gjelder kun for selvstendig næringsdrivende.',
    ...
    },
    {
        ...
        'description': 'Du kan søke om frivillig medlemskap hvis du skal oppholde deg i Norge under 12 måneder, for eksempel som student. Dette gjelder også deg som bor i Norge, men som skal jobbe på en utenlandsk ambassade, i en mellomfolkelig organisasjon eller på et utenlandskregistrert skip.',
    ...
    },
    {
        ...
        'description': 'If you live in another EEA country or Switzerland and only work in Norway, you can use this form to apply for confirmation that you are covered by Norwegian social security legislation and thus not obliged to pay social security contributions in another country.\n\nIf you work in one or more countries besides Norway, you must instead contact the social security authorities in the country where you live.\n\n',
        'url': 'https://www.nav.no/soknader/en/person/til-eller-fra-norge/opphold-eller-arbeid-i-norge#NAV020807',
        'language': 'en',
    },
    {
        'displayName': 'Søknad om A1 - Avklaring av trygdetilhørighet når du arbeider eller driver selvstendig næringsvirksomhet innen EØS/Sveits (i Norge) - NAV 02-08.07',
        'description': 'Hvis du bor i et annet EØS-land eller Sveits og kun arbeider i Norge, kan du bruke dette skjemaet for å søke om bekreftelse på at du er omfattet av norsk trygdelovgivning og ikke skal betale trygdeavgift i andre land.\n\nArbeider du både i Norge og ett eller flere andre land, må du i stedet kontakte trygdemyndigheten i bostedslandet ditt.\n\n',
        'url': 'https://www.nav.no/soknader/nb/person/til-eller-fra-norge/opphold-eller-arbeid-i-norge#NAV020807',
        'language': 'nb',
    },
    {
        'displayName': 'Form for cash-for-care benefit - NAV 34-00.08',
        'description': 'The child must be between one and two years old. Adopted children can not have started school yet. You can receive cash-for-care benefit from the calendar month after the child have turned one year old and for a maximum of for 11 months. The application must be sent one month prior to the time you are to be granted cash-for-care benefit.',
    ...
    },
    {
        ...
        'description': 'Barnet må være mellom ett og to år. Adoptivbarn kan ikke ha begynt på skolen. Du kan tidligst få kontantstøtte fra måneden etter at barnet fyller ett år og kun i 11 måneder. Søknaden må sendes tidligst en måned før du ønsker å få kontantstøtte.\n\n',
    ...
    },
    {
        ...
        'description': 'Child benefit is as a rule implemented automatically for children born in Norway. If you are not receiving child benefit, you use this form to apply for it.\n\n\n\n',
        'url': 'https://www.nav.no/soknader/en/person/til-eller-fra-norge/opphold-eller-arbeid-i-norge#NAV330007',
        'language': 'en',
    },
    {
        'displayName': 'Søknad om barnetrygd ordinær - NAV 33-00.07',
    ...
    },
    {
        ...
        'description': 'If you have a medical certificate from a doctor outsideNorway, you must complete this form, attach the medical certificate and send the documents to NAV.',
    ...
    {
        'displayName': 'A1 application – Determination of applicable social security legislation while working in the EEA or Switzerland (outside Norway) - NAV 02-08.07',
        'description': 'Use this form to apply for confirmation that you are covered by Norwegian social security and thus are not obliged to pay social security contributions in another country if you:\n\nare going to work temporarily in another EEA country or Switzerland, for instance because you are posted overseas by a Norwegian employer. In this case, your employer must complete the form NAV 02- 08.08.\n\nlive in Norway and regularly alternate between working in two or more countries within the EEA area.\n\nIf you live in another EEA country or Switzerland and alternate between working in two or more countries, you must instead contact the social security authorities  in the country where you live.\n\nWhen you sign in at Ditt NAV, you come to your personal page at nav.no. You can only submit applications that apply to you personally, since documents sent via Ditt NAV get your signature and are filed on you in our systems. If you need to submit an application on behalf of another person, the application must be sent by post, together with a first page with the birth number of the person to whom the application applies.\n\n\n\n',
        'url': 'https://www.nav.no/soknader/en/person/til-eller-fra-norge/opphold-eller-arbeid-utenfor-norge#NAV020807',
        'language': 'en',
    },
    {
        'displayName': 'Søknad om A1 - Avklaring av trygdetilhørighet når du arbeider eller driver selvstendig næringsvirksomhet innen EØS/Sveits (utenfor Norge)  - NAV 02-08.07',
        'description': 'Dette skjemaet bruker du for å søke om bekreftelse på at du er omfattet av norsk trygdelovgivning og ikke skal betale trygdeavgift i andre land hvis du:\n\nskal arbeide midlertidig i et annet EØS-land eller Sveits, for eksempel fordi du er utsendt arbeidstaker eller praktikant. Er du utsendt arbeidstaker, må vi også ha skjema NAV 02-08.08, «Skjema for arbeidsgiver som sender en arbeidstaker på midlertidig oppdrag til et annet EØS-land eller Sveits».\n\nbor i Norge og regelmessig veksler mellom å arbeide i to eller flere land i EØS-området.\n\nHvis du bor i et annet EØS-land eller Sveits og veksler mellom å arbeide i to eller flere land, må du i stedet kontakte trygdemyndigheten i bostedslandet ditt.\n\nNår du logger deg på Ditt NAV, kommer du til din personlige side på nav.no. Herfra kan du kun sende inn søknader som gjelder deg personlig, siden dokumenter sendt via Ditt NAV får din signatur og blir arkivert på deg i våre systemer. Skal du sende inn søknad på vegne av en annen person, må søknaden sendes i posten, sammen med en førsteside med fødselsnummeret til den personen søknaden gjelder.',
        'url': 'https://www.nav.no/soknader/nb/person/til-eller-fra-norge/opphold-eller-arbeid-utenfor-norge#NAV020807',
        'language': 'nb',
    },
    {
        'displayName': 'Application to be covered by Norwegian social security legislation during stay in the EEA / Switzerland - NAV 02-08.09',
        'description': "You may use this form if you are going to stay in another EEA country or Switzerland and will apply to be covered by Norwegian social security legislation. This may be relevant if, for example, you are a student or family member of a posted employee. If you want to work during this period, you must use form NAV 02-08.07.\n\nIf you receive a pension or disability benefit from the National Insurance Scheme and move to another EEA country / Switzerland, you must contact Helfo for confirmation that you are entitled to healthcare.\n\nIf you travel with children, you must fill in your own application for each child. The application must be sent in the mail, enclosed with a first page with the child's national ID number.\n\nWhen signing in at Ditt NAV, you enter your personal page at nav.no. From here you can only submit applications that apply to you personally, since documents sent via Ditt NAV get your signature and are filed on you in our systems. If you need to submit an application on behalf of another person, the application must be submitted by mail, together with a first page with the birth number of the person to whom the application applies.",
        'url': 'https://www.nav.no/soknader/en/person/til-eller-fra-norge/opphold-eller-arbeid-utenfor-norge#NAV020809',
        'language': 'en',
    },
    {
        'displayName': 'Søknad om å være omfattet av norsk trygdelovgivning under opphold i et annet EØS-land eller Sveits - NAV 02-08.09',
        'description': 'Dette skjemaet kan du bruke hvis du skal oppholde deg i et annet EØS-land eller Sveits, og vil søke om å være omfattet av norsk trygdelovgivning. Det kan være aktuelt hvis du for eksempel er student eller familiemedlem til en utsendt arbeidstaker. Skal du arbeide i denne perioden, må du bruke skjema NAV 02-08.07.\n\nHvis du får pensjon eller uføretrygd fra folketrygden og flytter til et annet EØS-land/Sveits, må du kontakte Helfo for å få bekreftelse på at du har rett til helsetjenester.\n\nReiser du sammen med barn, må det fylles ut egen søknad for hvert barn. Søknaden må sendes i posten, vedlagt en førsteside med barnets fødselsnummer.\n\nVed innlogging på Ditt NAV, kommer du inn på din personlige side på nav.no. Herfra kan du kun sende inn søknader som gjelder deg personlig, siden dokumenter sendt via Ditt NAV får din signatur og blir arkivert på deg i våre systemer. Skal du sende inn søknad på vegne av en annen person, må søknaden sendes i posten, sammen med en førsteside med fødselsnummeret til den personen søknaden gjelder.\n\n',
        'url': 'https://www.nav.no/soknader/nb/person/til-eller-fra-norge/opphold-eller-arbeid-utenfor-norge#NAV020809',
        'language': 'nb',
    },
    {
        'displayName': 'Application for membership in the National Insurance Scheme during stay outside Norway - NAV 02-08.05',
        'description': 'You use this form if you are going to work or stay in countries outside the EEA area.',
        'url': 'https://www.nav.no/soknader/en/person/til-eller-fra-norge/opphold-eller-arbeid-utenfor-norge#NAV020805',
        'language': 'en',
    },
    {
    ...
    },
    {
        ...
        'description': 'Denne søknaden bruker du hvis du ønsker å reise ut av Norge mens du er sykmeldt og du samtidig ønsker å beholde sykepengene. Du må sende søknaden før du reiser.\n\nSkal du avvikle lovbestemt ferie utenfor Norge, skal du ikke søke. I stedet krysser du av for ferie i søknaden om sykepenger som sendes etter at sykmeldingsperioden er over.',
    ...
    },
    {
        ...
        'description': 'Dersom du bor i utlandet og har rett til ytelse fra NAV, kan NAV utbetale ytelsene direkte til din bankkonto i utlandet.\n\nDette skjemaet bruker du hvis du vil utbetalinger fra NAV til konto i utlandet.',
    ...
    },
    {
        ...
        'description': 'If you live or work in a European country and are entitled to benefits from NAV, the payments can be sent directly to your account in the European country.',
    ...
    },
    {
        ...
        'description': 'Dersom du bor eller arbeider i et europeisk land og har rett til ytelser fra NAV, kan NAV utbetale ytelsene direkte til din bankkonto i det landet der du bor eller arbeider.\n\nDette skjemaet bruker du dersom du vil ha utbetalinger fra NAV til konto i Europa.',
    ...
    },
    {
        ...
        'description': 'Dersom du bor i Australia og har rett til ytelse fra NAV, kan NAV utbetale ytelsene direkte til din bankkonto i Australia.\n\nDette skjemaet bruker du hvis du vil utbetalinger fra NAV til konto i Australia.',
    ...
    },
    {
        ...
        'description': 'Dersom du bor i Canada og har rett til ytelse fra NAV, kan NAV utbetale ytelsene direkte til din bankkonto i Canada.\n\nDette skjemaet bruker du hvis du vil utbetalinger fra NAV til konto i Canada.',
    ...
    },
    {
        ...
        'description': 'Dersom du bor i Mexico og har rett til ytelse fra NAV, kan NAV utbetale ytelsene direkte til din bankkonto i Mexico.\n\nDette skjemaet bruker du hvis du vil utbetalinger fra NAV til konto i Mexico.',
    ...
    },
    {
        ...
        'description': 'If you live or work in South Africa and are entitled to benefits from NAV, the payments can be sent directly to your account in South Africa.',
    ...
    },
    {
        ...
        'description': 'Dersom du bor i Sør-Afrika og har rett til ytelse fra NAV, kan NAV utbetale ytelsene direkte til din bankkonto i Sør-Afrika.\n\nDette skjemaet bruker du hvis du vil utbetalinger fra NAV til konto i Sør-Afrika.',
        'url': 'https://www.nav.no/soknader/nb/person/til-eller-fra-norge/kontoendringer#NAV950019',
        'language': 'nb',
    },
    {
        'displayName': 'Bank information form – South Africa - NAV 95-00.06',
    ...
    },
    {
        ...
        'description': 'Dersom du bor i USA og har rett til ytelse fra NAV, kan NAV utbetale ytelsene direkte til din bankkonto i USA.\n\nDette skjemaet bruker du hvis du vil ha utbetalinger fra NAV til konto i USA.',
    ...
    },
    {
        ...
        'description': 'If you are sent by your employer to work in the USA for a period of up to 5 years, your Norwegian employer must complete this form, in addition to the application form for membership in the Norwegian National Insurance Scheme while living abroad (form NAV 02-08.05).',
        'url': 'https://www.nav.no/soknader/en/person/til-eller-fra-norge/certificates-of-coverage#NAV420120',
        'language': 'en',
    },
    {
        'displayName': 'Attest for utsendte arbeidstakere fra Norge til USA - NAV 42-01.20',
        'description': '',
        'url': 'https://www.nav.no/soknader/nb/person/til-eller-fra-norge/certificates-of-coverage#NAV420120',
        'language': 'nb',
    },
    {
        'displayName': 'Certificate for continuing coverage under the Norwegian national insurance scheme - Canada - NAV 42-02.10',
        'description': 'If you are sent by your Norwegian employer to work in Canada for a period of up to 3 years, your employer must complete this form, in addition to the application form for membership in the Norwegian National Insurance Scheme while living abroad (form NAV 02-08.05).',
        'url': 'https://www.nav.no/soknader/en/person/til-eller-fra-norge/certificates-of-coverage#NAV420210',
        'language': 'en',
    },
    {
        'displayName': 'Certificate of continuing coverage under the Norwegian National Insurance Scheme based on agreement on social security between the Kingdom of Norway and Australia - NAV 42-03.04',
        'description': 'If you are sent by your Norwegian employer to work in Australia for a period of up to 3 years, your employer must complete this form, in addition to the application form for membership in the Norwegian National Insurance Scheme while living abroad (form NAV 02-08.05).',
        'url': 'https://www.nav.no/soknader/en/person/til-eller-fra-norge/certificates-of-coverage#NAV420304',
        'language': 'en',
    },
    {
        'displayName': 'Certificate of Continuing liability to Norwegian legislation - Great Britain or Northern Ireland - NAV 42-02.12',
        'description': 'If you are sent by your Norwegian employer to work in Great Britain or Northern Ireland for a period of up to 3 years, your employer must complete this form, in addition to the application form for membership in the Norwegian National Insurance Scheme while living abroad (form NAV 02-08.05).',
        'url': 'https://www.nav.no/soknader/en/person/til-eller-fra-norge/certificates-of-coverage#NAV420212',
        'language': 'en',
    },
    {
        'displayName': 'Confirmation of membership the Norwegian National Insurance Scheme in accordance with the Agreement on Social Insurance between Norway and Quebec - NAV 42-02.11',
        'description': 'If you are sent by your Norwegian employer to work in Quebec for a period of up to 3 years, your employer must complete this form, in addition to the application form for membership in the Norwegian National Insurance Scheme while living abroad (form NAV 02-08.05).',
        'url': 'https://www.nav.no/soknader/en/person/til-eller-fra-norge/certificates-of-coverage#NAV420211',
        'language': 'en',
    },
    {
        'displayName': 'Certificate of continuing coverage under the Norwegian National Insurance Scheme based on agreement on social security between the Kingdom of Norway and the Republic of India - NAV 42-02.15',
        'description': 'If you are sent by your Norwegian employer to work in India with payment from the norwegian employer, your employer must complete the form Confirmation of membership in the Norwegian National Insurance Scheme in accordance with the Agreement on Social Insurance between Norway and India.',
        'url': 'https://www.nav.no/soknader/en/person/til-eller-fra-norge/certificates-of-coverage#NAV420215',
        'language': 'en',
    },
    {
        'displayName': 'Bekreftelse på medlemskap i folketrygden etter avtale om sosial trygd mellom Norge og India - NAV 42-02.15',
        'description': 'Bekreftelse på medlemskap i folketrygden etter avtale om sosial trygd mellom Norge og India - NAV 42-02.15 gjelder deg som er utsendt arbeidstaker til India med lønn fra norsk arbeidsgiver.',
        'url': 'https://www.nav.no/soknader/nb/person/til-eller-fra-norge/certificates-of-coverage#NAV420215',
        'language': 'nb',
    },
    {
        'displayName': 'Forsikring mot ansvar for sykepenger i arbeidsgiverperioden for små bedrifter - krav om refusjon - NAV 08-21.15',
        'description': 'Dette skjemaet bruker du som arbeidsgiver for å be om refusjon av sykepenger som du har utbetalt til arbeidstaker i arbeidsgiverperioden. Du må ha gyldig forsikring for små bedrifter for å få refundert sykepenger i arbeidsgiverperioden. Skjemaet bruker du kun for fravær i arbeidsgiverperioden, det vil si fra 4. til 16. fraværsdag.',
        'url': 'https://www.nav.no/soknader/nb/bedrift/refusjoner/sykepenger-arbeidsgiverperioden#NAV082115',
        'language': 'nb',
    },
    {
        'displayName': 'Søknad om refusjon av reisetilskudd til arbeidsreiser (for arbeidsgiver) - NAV 08-14.01',
        'description': 'For at arbeidsgiver skal kunne fremsette krav om refusjon, må arbeidstaker ha søkt og fått innvilget reisetilskudd fra NAV. Hvis du som arbeidsgiver dekker transportutgiftene til arbeidstaker, kan du søke om refusjon av dine utlegg.\n\nArbeidsgiver skal bruke dette skjemaet hver gang du sender inn dokumentasjon på dine utlegg.\n\nReisetilskuddet skal dekke nødvendige ekstra transportutgifter. Arbeidstakeren kan få reisetilskudd i stedet for sykepenger eller i kombinasjon med graderte sykepenger, jf folketrygdlovens § 8-14.',
    ...
    },
    {
        ...
        'description': 'Dette skjemaet brukes av tiltaksarrangør som som har fått tilsagn fra NAV for kvalifisering eller tilrettelagt arbeid i arbeidsmarkedsbedrift og som skal be om refusjon av tilsagnsbeløp.',
        'url': 'https://www.nav.no/soknader/nb/bedrift/refusjoner/kvalifisering-og-amb#NAV761360',
        'language': 'nb',
    },
    {
        'displayName': 'Refusjonskrav – Varig tilrettelagt arbeid (VTA) i ordinær virksomhet - NAV 76-13.54',
        'description': 'Dette skjemaet brukes av tiltaksarrangør som har fått tilsagn fra NAV for varig tiltrettelagt arbeid (VTA) i ordinær virksomhet og som skal be om refusjon av tilsagnsbeløp.',
        'url': 'https://www.nav.no/soknader/nb/bedrift/refusjoner/vta-ordinaer#NAV761354',
        'language': 'nb',
    },
    {
        'displayName': 'Tilskudd til bedriftsintern opplæring - NAV 76-13.26',
        'description': 'Brukes av bedrift som har fått tilsagn fra NAV om Bedriftsintern opplæring (BIO) og som skal be om refusjon av tilskuddsbeløp. \n\nLes mer om bedriftsintern opplæring ',
    ...
    },
    {
        ...
        'description': 'Dette skjemaet brukes av tiltaksarrangør som har fått tilsagn fra NAV for opplæringstiltak (AMO-kurs eller ordinær utdanning) og som skal be om refusjon av tilsagnsbeløp.',
    ...
    },
    {
        ...
        'description': 'Dette skjemaet brukes av tiltaksarrangør som har fått tilsagn fra NAV for arbeid med bistand og som skal be om refusjon av tilsagnsbeløp.',
        'url': 'https://www.nav.no/soknader/nb/bedrift/refusjoner/arbeid-med-bistand#NAV761350',
        'language': 'nb',
    },
    {
        'displayName': 'Krav fra arbeidsgiveren om refusjon av sykepenger utbetalt i arbeidsgiverperioden til en arbeidstaker som er unntatt fra arbeidsgiveransvar - NAV 08-20.12',
        'description': 'Dette skjemaet bruker du hvis du skal kreve refusjon for sykepenger utbetalt i arbeidsgiverperioden.\n\nViktig informasjon om kronisk syk eller gravid arbeidstaker. ',
        'url': 'https://www.nav.no/soknader/nb/bedrift/refusjoner/refusjon-sykdom-svangerskap#NAV082012',
        'language': 'nb',
    },
    {
        'displayName': 'Refusjonskrav til ekspertbistand - NAV 76-13.90',
        'description': 'Dette skjemaet brukes av arbeidsgiver for refusjon av ekspertbistand. Dokumentasjon på faktiske kostnader må alltid være vedlagt skjema NAV 76.13-90 Refusjonskrav til ekspertbistand. \n\nInformasjon om refusjonkrav til ekspertbistand. ',
        'url': 'https://www.nav.no/soknader/nb/bedrift/refusjoner/refusjon-ekspertbistand#NAV761390',
        'language': 'nb',
    },
    {
    ...
    {
        'displayName': 'Rapportering av tiltak, underveis- og sluttevalueringer - NAV 00-03.00',
        'description': 'Velg dette "skjemaet" for innsending av rapporter som gjelder tiltak og underveis- og sluttevalueringer.\n\nDummy-skjemaet skal ikke sendes inn. Vedlegget "Annet" er det sokumentet du skal sende inn.',
        'url': 'https://www.nav.no/soknader/nb/bedrift/for-tiltaksarrangor/rapportering-underveis-og-sluttevaluering#NAV000300',
        'language': 'nb',
    },
    {
    ...
    },
    {
        ...
        'description': 'Avtalen skal fylles ut i samarbeid mellom arbeidsgiver, arbeidssøker og NAV.\n\n',
    ...
    },
    {
        ...
        'description': 'Brukes for å inngå en avtale om arbeidstrening mellom arbeidssøker, arbeidsgiver og NAV.\n\nDette tiltaket kan kombineres med inkluderingstilskudd.',
    ...
    },
    {
        ...
        'description': 'Arbeidsgivere som har arbeidstakere med tilskudd fra NAV til funksjonsassistanse kan søke om inkluderingstilskudd til dekning av dokumenterte merutgifter til tilrettelegging av arbeidsplassen.\n\nLes mer om inkluderingstilskudd\n\nVelg skjema for inkluderingstilskudd',
    ...
    },
    {
        ...
        'description': 'Arbeidsgivere som har arbeidstakere på varig tilrettelagt arbeid i ordinær virksomhet kan søke om inkluderingstilskudd til dekning av dokumenterte merutgifter til tilrettelegging av arbeidsplassen.\n\nLes mer om inkluderingstilskudd\n\nVelg skjema for inkluderingstilskudd',
    ...
    },
    {
        ...
        'description': 'Dette skjemaet skal du fylle ut når du skal søke om sykepenger fra NAV. Du skal kun fylle ut og sende inn dette skjemaet én gang. Hvis du sender inn nye sykepengekrav (forlengelser) skal du ikke fylle ut skjemaet.\n\nHvis du i løpet av de siste fire årene har startet næringsvirksomhet eller fått en varig endring av arbeidssituasjonen/virksomheten, må du dokumentere dette. ',
    ...
    {
        'displayName': 'Inntektsopplysninger for selvstendig næringsdrivende og/eller frilansere som skal ha omsorgs-, pleie- eller opplæringspenger - NAV 09-35.01',
        'description': 'Dette skjemaet skal du fylle ut når du skal søke om omsorgs-, opplærings- eller pleiepenger fra NAV.\n\nHvis du i løpet av de siste fire årene har startet næringsvirksomhet eller fått en varig endring av arbeidssituasjonen/virksomheten, må du dokumentere dette. \n\nHvis du er jordbruker, må du også legge ved RF-skjema 1224 fra skatteetaten som viser hvor mye av næringsinntekten som utgjør jordbruksinntekten.\n\nNB: En av legeerklæringene må følge søknaden.',
        'url': 'https://www.nav.no/soknader/nb/bedrift/inntekt-og-trekk/inntektsopplysninger-omsorgs-opplaering-pleiepenger#NAV093501',
        'language': 'nb',
    },
    {
        'displayName': 'Trekkopplysninger for arbeidstaker som skal ha: sykepenger, foreldrepenger, svangerskapspenger, pleie-/opplæringspenger og omsorgspenger - NAV 08-30.02',
        'description': 'Dette skjemaet brukes for å opplyse NAV om trekk hos arbeidstaker i forbindelse med utbetaling av sykepenger, foreldrepenger, svangerskapspenger eller pleie-/ opplærings- og omsorgspenger.',
    ...
    {
        'displayName': 'Power of attorney - NAV 95-15.36',
        'description': 'To be certain that your personal information is not given to unauthorized personnel, we kindly ask you to fill in this form and return it to NAV as soon as possible.',
        'url': 'https://www.nav.no/soknader/en/person/diverse/fullmaktskjema#NAV951536',
        'language': 'en',
    },
    {
        'displayName': 'Generell fullmakt - NAV 95-15.36',
        'description': 'For å sikre at ingen uvedkommende får opplysninger i saken din hos NAV, må du gi fullmakt til den eller de personene som du vil at skal ha innsyn i saken din. Du kan gi fullmakt ved å bruke dette skjemaet. Du bestemmer selv hva fullmakten skal omfatte, og hvor lenge den skal gjelde.\n\n',
        'url': 'https://www.nav.no/soknader/nb/person/diverse/fullmaktskjema#NAV951536',
        'language': 'nb',
    },
    {
        'displayName': 'Fullmakt i samband med søknad om hjelpemiddel - NAV 10-07.04',
        'description': 'rgfd',
    ...
    },
    {
        ...
        'description': 'You can change which bank account you want NAV to use by logging in to "Ditt NAV" (Norwegian only). This will save the change immediately.',
    ...
    },
    {
        ...
        'description': 'Dersom du skal endre bankkontonummer, bruker du dette skjemaet for bankopplysninger i Norge. Gjelder for utbetalinger både fra NAV og HELFO.',
    ...
    },
    {
        ...
        'description': 'Dersom du ønsker ekstra skattetrekk, kan du søke om det her. Vi gjør oppmerksom på at dette er en frivillig avtale som gjelder ut inneværende år, eller inntil du selv sender skriftlig melding om stans. Ekstra skattetrekk vil gjelde alle måneder, også ordinære skattefrie måneder.\n\nØnsker du ekstra skattetrekk i pensjon, bestiller du det på Din Pensjon under din profil.',
    ...
    },
    {
        'displayName': 'Oppfølging bistand - NAV 00-01.00',
        'description': 'Oppfølging i forbindelse med bistand fra NAV\n\nDersom du allerede er i dialog med NAV og skal sende inn kjøreliste, legeerklæring, jobblogg eller annen dokumentasjon i forbindelse med oppfølging, velger du lenken under her og går videre.',
        'url': 'https://www.nav.no/soknader/nb/person/diverse/oppfolging-kjorelister#NAV000100',
        'language': 'nb',
    },
    {
        'displayName': 'Oppfølging arbeidsavklaring - NAV 00-02.00',
        'description': 'Bruk lenken nedenfor hvis du enten mottar tilleggsstønader og skal sende inn kjøreliste, eller hvis du mottar arbeidsavklaringspenger og skal sende inn annen dokumentasjon for å følge opp saken din.\n\nDisse vedleggene bruker du i forbindelse med arbeidsavklaringspenger.',
        'url': 'https://www.nav.no/soknader/nb/person/diverse/oppfolging-kjorelister#NAV000200',
        'language': 'nb',
    },
    {
        'displayName': 'Melding om midlertidig postadresse i NAV - NAV 95-20.20',
        'description': 'Dette skjemaet bruker du hvis du vil endre adressen der du vil motta post i inntil et år. Du kan også melde endring av adresse direkte i selvbetjeningsløsningene på nav.no. Les mer om dette på siden det lenkes til nedenfor.',
    ...
    },
    {
        ...
        'description': "You use this form to report starting or ending of a cohabitant relationship. You can also use the form to report changes in the cohabitant's income.",
    ...
    },
    {
        ...
        'description': 'Dette skjemaet bruker du når du skal melde fra om inngåelse eller opphør av samboerskap. Du kan også bruke skjemaet til å melde fra om endring i samboers inntekt.',
    ...
    {
        'displayName': 'Bekreftelse på arbeidsforhold og permittering - NAV 04-08.04',
        ...
        'url': 'https://www.nav.no/soknader/nb/bedrift/permitteringer-oppsigelser-og-konkurs/permitteringsaarsak#NAV040804',
        'language': 'nb',
    },
    {
        'displayName': 'Forespørsel til arbeidsgiver i forbindelse med permittering - NAV 04-07.05',
        'description': 'Dette skjemaet brukes for å innhente dokumentasjon fra drøftelser med ansatte i forbindelse med permittering, samt navneliste over de permitterte.',
    ...
    },
    {
        ...
        'description': 'As custodial parent and non-custodial parent you may use this form to make a private agreement on child support.  If you want NAV to claim the agreed upon child support, you must submit a copy of the agreement to NAV.\n\nThis form should be sent to the NAV office you belong to. The name and address of the NAV office can be found at Ditt NAV.',
    ...
    },
    {
        ...
        'description': 'Dette skjemaet kan dere bruke når dere skal inngå  privat avtale om bidrag. Dersom dere ønsker at NAV skal innkreve det avtalte sender dere en kopi av avtalen til NAV.  \n\nDette skjemaet skal sendes til det NAV-kontoret du tilhører. Navn og adresse til NAV-kontoret finner du på Ditt NAV.\n\n\n\n',
    ...
    },
    {
        ...
        'description': 'You may use this form to make a private agreement on child support for the child over 18 years of age. Use one form for each of the parents if both of the parentes are going to make a agreement.\n\nThis form should be sent to the NAV office you belong to. The name and address of the NAV office can be found at Ditt NAV.',
    ...
    },
    {
        ...
        'description': 'Dette skjemaet kan dere bruke når dere skal inngå  privat avtale om barnebidrag  og barnet er over 18 år. Bruk ett skjema for hver av foreldrene dersom det skal inngås avtale med begge.\n\nDette skjemaet skal sendes til det NAV-kontoret du tilhører. Navn og adresse til NAV-kontoret finner du på Ditt NAV.\n',
    ...
    },
    {
        ...
        'description': 'You can use this form if you want to apply for establishment or alteration of advanced payments of child support.  Children over the age of 18 must apply for themselves. \n\nYou can use the same application form to apply for advanced payments.\n\nThis form should be sent to the NAV office you belong to. The name and address of the NAV office can be found at Ditt NAV.\n\n',
    ...
    },
    {
        ...
        'description': 'Søknadsskjemaet skal du bruke dersom du er bidragsmottaker og søker om fastsettelse eller endring av barnebidrag. Barn over 18 år må søke selv\n\nGjelder også for søknad om forskudd.\n\nDette skjemaet skal sendes til det NAV-kontoret du tilhører. Navn og adresse til NAV-kontoret finner du på Ditt NAV.\n\n\n\n\n',
    ...
    {
        'displayName': 'Response to advance notice regarding child support form for non-custodial parent - NAV 54-00.07',
        'description': 'You use this form to give information after you receive an advance notice regarding child support.\n\nThis form should be sent to the NAV office you belong to. The name and address of the NAV office can be found at Ditt NAV.',
        'url': 'https://www.nav.no/soknader/en/person/familie/barnebidrag-og-bidragsforskudd#NAV540007',
        'language': 'en',
    },
    {
    ...
    },
    {
        ...
        'description': 'Gjelder dersom du har hatt særlige utgifter til barn og søker om et bidrag fra den andre forelderen. For eksempel utgifter til briller,linser,konfirmasjon eller tannregulering. Husk å sende kopi av kvittering eller faktura på utgiften du søker om særlig bidrag for.\n\nDette skjemaet skal sendes til det NAV-kontoret du tilhører. Navn og adresse til NAV-kontoret finner du på Ditt NAV.',
    ...
    },
    {
        ...
        'description': 'Gjelder dersom du er bidragspliktig og skal søke om at NAV skal slette bidragsgjelden din. Skjemaet kan også brukes hvis du i tillegg søker om at barnebidraget skal endres. Dersom du har bidragsgjeld for barn i ulike bidragssaker må du fylle ut en søknad for hver bidragssak.\n\nDette skjemaet skal sendes til det NAV-kontoret du tilhører. Navn og adresse til NAV-kontoret finner du på Ditt NAV.',
    ...
    },
    {
        ...
        'description': 'Dette gjelder kun dersom du er enslig mor eller far. Enslig mindreårig asylsøkere som bor i egen bolig kan også ha rett til utvidet barnetrygd.',
        'url': 'https://www.nav.no/soknader/nb/person/familie/barnetrygd#NAV330009',
        'language': 'nb',
    },
    {
        'displayName': 'Tilleggsskjema ved krav om utbetaling av barnetrygd og/eller kontantstøtte på grunnlag av regler om eksport etter EØS-avtalen - NAV 34-00.15',
        'description': 'Dette skjemaet bruker du hvis du jobber i Norge og barnet ditt bor i et annet EØS-land. Skjemaet benyttes som vedlegg til søknad om barnetrygd og kontantstøtte.',
        'url': 'https://www.nav.no/soknader/nb/person/familie/barnetrygd#NAV340015',
        'language': 'nb',
    },
    {
        'displayName': 'Form for cash-for-care benefit - NAV 34-00.08',
        'description': 'The child must be between one and two years old. Adopted children can not have started school yet. You can receive cash-for-care benefit from the calendar month after the child have turned one year old and for a maximum of for 11 months. The application must be sent one month prior to the time you are to be granted cash-for-care benefit.',
        'url': 'https://www.nav.no/soknader/en/person/familie/kontantstotte#NAV340008',
        'language': 'en',
    },
    {
        'displayName': 'Søknad om kontantstøtte til småbarnsforeldre - NAV 34-00.08',
        'description': 'Barnet må være mellom ett og to år. Adoptivbarn kan ikke ha begynt på skolen. Du kan tidligst få kontantstøtte fra måneden etter at barnet fyller ett år og kun i 11 måneder. Søknaden må sendes tidligst en måned før du ønsker å få kontantstøtte.\n\n',
        'url': 'https://www.nav.no/soknader/nb/person/familie/kontantstotte#NAV340008',
        'language': 'nb',
    },
    {
        'displayName': 'Application for spousal support - NAV 53-00.05',
        'description': 'You can use this form to \n\napply for a stipulated or changed spousel support\n\nprovide information about your case \n\napply for a cessation of contributions\n\nEach of you may at any time request the collection of the defined spouse contribution.\n\nThis form should be sent to the NAV office you belong to. The name and address of the NAV office can be found at Ditt NAV.\n\nIf you have questions about spouse contributions, contact NAV.',
        'url': 'https://www.nav.no/soknader/en/person/familie/ektefellebidrag#NAV530005',
        'language': 'en',
    },
    {
        'displayName': 'Søknad − underholds­­bidrag til ektefelle - NAV 53-00.05',
        'description': 'Dette skjemaet bruker du når du skal\n\nsøke om å få fastsatt eller endret ektefellebidrag\n\ngi opplysninger i sak om ektefellebidrag\n\n søke/be om opphør av bidrag\n\nHver av dere kan når som helst be om innkreving av det fastsatte ektefellebidraget.\n\nDette skjemaet skal sendes til det NAV-kontoret du tilhører. Navn og adresse til NAV-kontoret finner du på Ditt NAV.\n\nDersom du har spørsmål om ektefellebidrag, ta kontakt med NAV. \n\n\n\n',
        'url': 'https://www.nav.no/soknader/nb/person/familie/ektefellebidrag#NAV530005',
        'language': 'nb',
    },
    {
        'displayName': 'Application for transitional benefit - single mother or father - NAV 15-00.01',
        'description': 'You may use this form if you are a single mother or father and apply for  transitional benefit. You can alsouse this link to apply for a new period of benefit.\n\nBelow you will find an overview of documentation that you must attach to the application. There may be similar attachments for some of the benefits for single mother or father. It is enough to send documentation together with one of the applications.',
        'url': 'https://www.nav.no/soknader/en/person/familie/enslig-mor-eller-far#NAV150001',
        'language': 'en',
    },
    {
        'displayName': 'Søknad om overgangsstønad - enslig mor eller far - NAV 15-00.01',
        'description': 'Gjelder kun hvis du er enslig mor eller far og søker om overgangsstønad. Du bruker også denne lenken om du skal søke om stønad for en ny periode.\n\nNedenfor finner du en oversikt over dokumentasjon som du må legge ved søknaden. Det kan være like vedlegg for noen av stønadene til enslig mor eller far. Det vil derfor være nok å sende dokumentasjon sammen med en av søknadene.\n\n\n\n',
        'url': 'https://www.nav.no/soknader/nb/person/familie/enslig-mor-eller-far#NAV150001',
        'language': 'nb',
    },
    {
        'displayName': 'Application for child care benefit for single mother or father when working - NAV 15-00.02',
        'description': 'You may use this form if you are a single mother or father and apply for child care benfit when working. You can alsouse this link to apply for a new period of benefit.\n\nBelow you will find an overview of documentation that you must attach to the application. There may be similar attachments for some of the benefits for single mother or father. It is enough to send documentation together with one of the applications.',
        'url': 'https://www.nav.no/soknader/en/person/familie/enslig-mor-eller-far#NAV150002',
        'language': 'en',
    },
    {
        'displayName': 'Søknad om stønad til barnetilsyn - enslig mor eller far i arbeid - NAV 15-00.02',
        'description': 'Gjelder kun søknad om barnetilsyn for enslig mor eller far som søker om barnetilsyn på grunn av arbeid eller etablering av egen virksomhet.\n\nNedenfor finner du en oversikt over dokumentasjon som du må legge ved søknaden. Det kan være like vedlegg for noen av stønadene til enslig mor eller far. Det vil derfor være nok å sende dokumentasjon sammen med en av søknadene.\n\n\n\n\n\n\n\n',
        'url': 'https://www.nav.no/soknader/nb/person/familie/enslig-mor-eller-far#NAV150002',
        'language': 'nb',
    },
    {
        'displayName': 'Application for support for tuition fees for education - single mother or father - NAV 15-00.04',
        'description': 'You may use this form if you are a single mother or father and apply for  support for tuition for education. Grants for tuition fees shall cover expenses for semester fees, examination fees and tuition fees. You can alsouse use this link to apply for a new period of benefit.\n\nYou can only receive tuition fees during the period you are entitled to transitional benefit. You must therefore also fulfill all the conditions for receiving transitional benefit.\n\nBelow you will find an overview of documentation that you must attach to the application. There may be similar attachments for some of the benefits for single mother or father. It is enough to send documentation together with one of the applications.',
        'url': 'https://www.nav.no/soknader/en/person/familie/enslig-mor-eller-far#NAV150004',
        'language': 'en',
    },
    {
        'displayName': 'Søknad om skolepenger - enslig mor eller far - NAV 15-00.04',
        'description': 'Gjelder kun hvis du søker om skolepenger og er alene med omsorgen for barn og under utdanning. Stønad til skolepenger skal dekke utgifter til semesteravgift, eksamensgebyr og skolepenger. Du bruker også denne lenken om du skal søke om stønad for en ny periode.\n\nDu kan bare motta skolepenger i den perioden du har rett til overgangsstønad. Du må derfor også oppfylle alle vilkårene for å motta overgangsstønad.\n\nNedenfor finner du en oversikt over dokumentasjon som du må legge ved søknaden. Det kan være like vedlegg for noen av stønadene til enslig mor eller far. Det vil derfor være nok å sende dokumentasjon sammen med en av søknadene.\n\n\n\n',
    ...
    {
        'displayName': 'Opplysnings- og søknadskjema i forbindelse med oppfostringsbidrag etter barnevernloven - NAV 57-00.08',
        'description': 'Dette skjemaet bruker du når barnevernet (kommunen) har satt frem søknad om fastsettelse av oppfostringsbidrag. Dere kan som foreldre begge være bidragspliktige, også når dere bor sammen.\n\nDersom du har spørsmål, ta kontakt med NAV.\n\nDette skjemaet bruker du:\n\nhvis du skal gi opplysninger fordi du har fått krav om å betale opppfostringsbidrag\n\nhvis du er pålagt å betale oppfostringsbidrag og søker om endringer\n\nhvis du søker om å få ettergitt gjeld i forbindelse med oppfostringsbidrag\n\nDette skjemaet skal sendes til det NAV-kontoret du tilhører. Navn og adresse til NAV-kontoret finner du på Ditt NAV.',
    ...
    },
    {
        ...
        'description': 'You can use this form for applying for a lump-sum grant. If you as a mother have not been working and have had income for at least 6 of the last 10 months before the benefit period starts, you can get a lump-sum grant instead of parental benefit at birth. \n\nIt is usually the mother who can receive lump-sum grant, and she must apply herself.\n\n',
    ...
    },
    {
        ...
        'description': 'Dette skjemaet bruker du når du søker om engangsstønad. Gjelder kun dersom du ikke har vært i arbeid og har hatt pensjonsgivende inntekt i minst 6 av de 10 siste månedene før stønadsperioden starter.\n\nDet er som regel mor som kan få engangsstønad, og hun må søke selv.\n\n',
        'url': 'https://www.nav.no/soknader/nb/person/familie/foreldrepenger-og-engangsstonad#NAV140507',
        'language': 'nb',
    },
    {
        'displayName': 'Application for parental benefit for an adoption - NAV 14-05.06',
        'description': 'You can only receive parental benefit if you have been employed and had income or benefits from NAV for at least 6 of the last 10 months before your parental benefit period starts.\n\nThe parents must each apply separately on separate forms, and they must each print a separate cover page.\n\nIf you are an employee, your employer must send a digital income message 4 weeks before your parental benefit period starts.',
    ...
    {
        'displayName': 'Application for a lump-sum grant upon an adoption - NAV 14-05.08',
        'description': 'You can use this form for applying for a lump-sum grant. If you as a mother have not been working and have had income for at least 6 of the last 10 months before the benefit period starts, you can get a lump-sum grant instead of parental benefit at birth. \n\nIt is usually the mother who can receive lump-sum grant, and she must apply herself.\n\n',
    ...
    },
    {
        ...
        'description': 'Svangerskapspenger gis til friske gravide kvinner som ikke kan fortsette i arbeidet under svangerskapet fordi det kan medføre risiko for skade på fosteret. Dersom du er selvstendig næringsdrivende eller frilanser, bruker du dette skjemaet for å søke om svangerskapspenger.\n\nEr du arbeidstaker, henter du riktig skjema og kan lese mer om søknadsprosessen her.',
    ...
    },
    {
        ...
        'description': 'Dette skjemaet brukes når du skal sende inn søknad om unntak fra arbeidsgiveransvar for sykepenger til arbeidstaker som lider av en langvarig eller kronisk sykdom.\n\nDette skjemaet bruker du hvis du vil søke om at arbeidsgiver fritas for plikten til å utbetale sykepenger i arbeidsgiverperioden',
    ...
    },
    {
        ...
        'description': 'Dette skjemaet brukes til å søke om unntak fra arbeidsgiveransvar for sykepenger til en arbeidstaker som har sykefravær på grunn av svangerskap, og som ikke kan omplasseres til annet arbeid i virksomheten.',
        'url': 'https://www.nav.no/soknader/nb/bedrift/sykepenger/unntak-arbeidsgiveransvar-svangerskapsrelatert#NAV082020',
        'language': 'nb',
    },
    {
        'displayName': 'Forsikring mot ansvar for sykepenger i arbeidsgiverperioden for små bedrifter - NAV 08-21.05 ',
        'description': '..',
        'url': 'https://www.nav.no/soknader/nb/bedrift/sykepenger/forsikring-arbeidsgiveransvar#NAV082105',
        'language': 'nb',
    },
    {
        'displayName': 'Forsikring mot ansvar for sykepenger i arbeidsgiverperioden for små bedrifter - krav om refusjon - NAV 08-21.15',
    ...
    },
    {
        ...
        'description': 'Oppfølgingsplanen er tilgjengelig for de som har tatt i bruk den digitale sykmeldingen. Planen utarbeides av arbeidstakeren og lederen på nav.no. Den kan deles med både legen og NAV fra løsningen.\n\nOppfølgingsplanen skal sendes uoppfordret til sykmelder når den er utarbeidet første gang, dvs ved 4 uker. NAV skal ha oppfølgingsplanen tilsendt når de ber om det.',
        'url': 'https://www.nav.no/soknader/nb/bedrift/sykepenger/oppfolgingsplan#NAV250201',
        'language': 'nb',
    },
    {
        'displayName': 'Krav fra arbeidsgiveren om refusjon av sykepenger utbetalt i arbeidsgiverperioden til en arbeidstaker som er unntatt fra arbeidsgiveransvar - NAV 08-20.12',
    ...
    {
        'displayName': 'Sykepenger - diverse - NAV 00-03.00',
        'description': 'Velg dette "skjemaet" hvis du skal\n\nBestride sykmelding\n\nSende bekreftelse på gjennomført behandling ved enkeltstående behandlingsdager\n\nSende inn sykepengekrav (del D)\n\nDokumentasjonen skal sendes til den NAV Arbeid og ytelser-enheten som betjener den ansattes fylke.',
        'url': 'https://www.nav.no/soknader/nb/bedrift/sykepenger/sykepenger-diverse#NAV000300',
        'language': 'nb',
    },
    {
        'displayName': 'Application for children’s pension when one parent has died - NAV 18-04.01',
        'description': "You use this form if you apply for children’s pension for children who have lost one of their parents. The pension shall ensure that the child has an income on which to live. Read more about children's pension",
    ...
    },
    {
        ...
        'description': 'You use this form if you apply for children’s pension when both parents have died, or have lost their mother and no paternity has been established. Read more about children’s pension',
    ...
    },
    {
        ...
        'description': 'Foreldreløse som er under utdanning kan ha rett til stønad inntil 20 år. Når dødsfallet skyldes en yrkesskade kan barnet har rett til barnepensjon under utdanning inntil 21 år.',
    ...
    },
    {
        ...
        'description': 'Gjelder kun dersom du er ugift, under 67 år og i minst fem år har pleiet en du har hatt en nær relasjon til. Du har ikke kunnet arbeide på grunn av pleieoppgavene, og heller ikke etterpå.',
        'url': 'https://www.nav.no/soknader/nb/person/stonader-ved-dodsfall/familiepleier#NAV160105',
        'language': 'nb',
    },
    {
        'displayName': 'Søknad om stønad til barnetilsyn på grunn av arbeid og stønad til skolepenger til gjenlevende ektefelle/partner/ samboer og til ugift familiepleier - NAV 15-12.01',
        'description': 'Gjelder kun utgifter du har til barnepass mens du studerer eller jobber. Studiene dine må være offentlig godkjent for at du skal få skolepenger',
    ...
    },
    {
        ...
        'description': 'Gjenlevendepensjon kan du søke om dersom din ektefelle er død eller dersom din samboer er død, og dere har eller har hatt felles barn.',
    ...
    },
    {
        ...
        'description': 'Barn under 18 år vil alltid ha rett til gravferdsstønad. Dersom et barn er dødfødt stilles det heller ikke krav til formue. I alle andre tilfeller er det formuen til avdøde eller formuen til avdøde og gjenlevende som avgjør om du har rett til gravferdsstønaden. ',
    ...
    {
        'displayName': 'Form for employer who sends an employee on temporary assignment to another EEA country or Switzerland - NAV 02-08.08',
        'description': "This form is a attachment to form NAV 02-08.07, \"Application for A1 - confirmation of social security membership when you work or run as a self-employed business within the EEA / Switzerland\". It must be completed when an employee is sent on temporary assignment to another EEA country or Switzerland, and sent to NAV together with the application. The employer's form should not be used if the employee regularly switches between working in Norway and one or more other countries.",
        'url': 'https://www.nav.no/soknader/en/bedrift/diverse-bedrift/utsendt-arbeidstaker#NAV020808',
        'language': 'en',
    },
    {
        'displayName': 'Skjema for arbeidsgiver som sender en arbeidstaker på midlertidig oppdrag til et annet EØS-land eller Sveits  - NAV 02-08.08',
        'description': 'Dette skjemaet er et vedlegg til skjema NAV 02-08.07, «Søknad om A1 - Avklaring av trygdetilhørighet når du arbeider eller driver selvstendig næringsvirksomhet innen EØS/Sveits». Det skal fylles ut når en arbeidstaker sendes på midlertidig oppdrag til et annet EØS-land eller Sveits, og sendes til NAV sammen med søknaden. Arbeidsgiverskjemaet skal ikke brukes hvis arbeidstakeren regelmessig veksler mellom å arbeide i Norge og ett eller flere andre land.\n\nHvis NAV ikke mottar skjemaet samtidig med søknaden, vil det ta lengre tid å behandle søknaden.\n\nNår du kommer til punktet «Oppgi hvem innsendelsen gjelder», må du\n\nkrysse av for «En privatperson» og oppgi fødselsnummeret til den utsendte arbeidstakeren eller\n\nkrysse av for «Flere personer samtidig» og oppgi «4530» som NAV-enhet\n\nLes mer om midlertidige arbeidsoppdrag i EØS-land eller Sveits',
        'url': 'https://www.nav.no/soknader/nb/bedrift/diverse-bedrift/utsendt-arbeidstaker#NAV020808',
        'language': 'nb',
    },
    {
        'displayName': 'Søknad om gravferdsstønad (Bedrift) - NAV 07-02.08',
        'description': 'Barn under 18 år vil alltid ha rett til gravferdsstønad. Dersom et barn er dødfødt stilles det heller ikke krav til formue. I alle andre tilfeller er det formuen til avdøde eller formuen til avdøde og gjenlevende som avgjør om du har rett til gravferdsstønaden. ',
    ...
    {
        'displayName': 'Diverse dokumentasjon - NAV 00-03.00',
        'description': 'Velg dette "skjemaet" for innsending av dokumentasjon som det ikke finnes skjemaer for. Det gjelder blant annet omsorgsovertakelse, omsorgsfordeling, \n\nDummy-skjemaet skal ikke sendes inn. Vedlegget "Annet" er det dokumentet du skal sende inn.',
        'url': 'https://www.nav.no/soknader/nb/bedrift/diverse-bedrift/diverse-dokumentasjon#NAV000300',
        'language': 'nb',
    },
    {
        'displayName': 'Application for Old Age Pension - NAV 19-01.05',
        'description': 'You use this form if you want to begin drawing retirement pension from January 2011 or later. The application will reach the case handler faster if you log in to “Din pensjon” and choose electronic application. Read more about retirement pension\n\n',
    ...
    },
    {
        ...
        'description': 'Søknaden din kommer raskere frem om du logger deg inn på "Din pensjon" og velger elektronisk søknad.',
    ...
    },
    {
        ...
        'description': 'If you are born in 1943 or later, and started drawing the pension at the earliest in January 2011, you may change the level of retirement pension you receive. It is easier to apply for flexible retirement pension electronically at “Din pensjon”, but you can also use the form below. Read more about flexible retirement pension',
    ...
    },
    {
        ...
        'description': 'Gjelder kun dersom du er født i 1943 eller senere. Du får raskere saksbehandling dersom du logger deg inn på "Din pensjon" og velger elektronisk søknad.',
    ...
    },
    {
        ...
        'description': 'Jeg vil gi beskjed om inntekter som ikke skal regnes med i etteroppgjøret og legger ved dokumentasjon som viser at inntekten er opptjent før uttak av AFP / etter opphør av AFP.',
    ...
    },
    {
        ...
        'description': 'If you have acquired rights for work caring for small children and wish to transfer these to the other parent, you use this form or go to “Din pensjon” and do it electronically.',
    ...
    },
    {
        ...
        'description': 'Dersom du har fått omsorgspoeng for et barn under 7 år og ønsker å overføre dette til den andre forelderen, kan du bruke skjemaet under, eller gå til «Din pensjon» og gjøre det elektronisk der. Les mer om omsorgsopptjening',
    ...
    },
    {
        'displayName': 'Søknad om gravferdsstønad (Bedrift) - NAV 07-02.08',
        'description': 'Barn under 18 år vil alltid ha rett til gravferdsstønad. Dersom et barn er dødfødt stilles det heller ikke krav til formue. I alle andre tilfeller er det formuen til avdøde eller formuen til avdøde og gjenlevende som avgjør om du har rett til gravferdsstønaden. ',
        'url': 'https://www.nav.no/soknader/nb/person/pensjon/gravferd#NAV070208',
        'language': 'nb',
    },
    {
        'displayName': 'Innleggelse i aldershjem/sykehjem - NAV 70-02.03',
        'description': '..',
        'url': 'https://www.nav.no/soknader/nb/person/pensjon/innleggelse-aldershjem#NAV700203',
        'language': 'nb',
    },
    {
        'displayName': 'Application for work assessment allowance - NAV 11-13.05',
        'description': 'You can apply for AAP if you need medical treatment or measures to help you get back to work. AAP ensures that you have income during periods when you, due to illness or injury, need help from NAV to get back to work.\n\nNB! You must first register as unemployed before you can apply for a work clarification allowance.',
        'url': 'https://www.nav.no/soknader/en/person/helse/arbeidsavklaringspenger#NAV111305',
        'language': 'en',
    },
    {
        'displayName': 'Søknad om arbeidsavklaringspenger - NAV 11-13.05',
    ...
    {
        'displayName': 'Application for basic benefit - NAV 06-03.04',
        'description': "This form is used if you have extra expenses due to an illness, injury or congenital defect and malformation (blemish). If you are applying on behalf of another person, you must fill in the birth number of the person the application applies to. For example, if it applies to a child, it is the child's birth number that you fill in.",
        'url': 'https://www.nav.no/soknader/en/person/helse/grunn-og-hjelpestonad#NAV060304',
        'language': 'en',
    },
    {
        'displayName': 'Søknad om grunnstønad - NAV 06-03.04',
        'description': 'Dette skjemaet bruker du hvis du har ekstrautgifter på grunn av en sykdom, skade eller medfødte feil og misdannelser (lyte). Hvis du søker på vegne av en annen person, må du fylle inn fødselsnummeret på personen søknaden gjelder. Gjelder den for eksempel et barn, er det barnets fødselsnummer du fyller inn. ',
        'url': 'https://www.nav.no/soknader/nb/person/helse/grunn-og-hjelpestonad#NAV060304',
        'language': 'nb',
    },
    {
        'displayName': 'Application for attendance allowance - NAV 06-04.04',
        'description': "You use this form if you have a special need for care and supervision.\n\nIf you are applying on behalf of another person, you must fill in the birth number of the person the application applies to. For example, if it applies to a child, it is the child's birth number that you fill in.",
        'url': 'https://www.nav.no/soknader/en/person/helse/grunn-og-hjelpestonad#NAV060404',
        'language': 'en',
    },
    {
        'displayName': 'Krav om hjelpestønad - NAV 06-04.04',
        'description': 'Dette skjemaet bruker du hvis du har et spesielt behov for pleie og tilsyn.\n\nHvis du søker på vegne av en annen person, må du fylle inn fødselsnummeret på personen søknaden gjelder. Gjelder den for eksempel et barn, er det barnets fødselsnummer du fyller inn.',
    ...
    },
    {
        ...
        'description': 'Yrkesaktive medlemmer som på sykmeldingstidspunktet midlertidig har vært ute av inntektsgivende arbeid i mindre enn en måned, og som fremdeles er ute av inntektsgivende arbeid, eller har vært i arbeid uten å fylle vilkåret om fire ukers opptjeningstid, kan ha krav på sykepenger fra NAV.\n\nDette skjemaet bruker du hvis det er under en måned siden forrige arbeidsforhold opphørte, du mottar etterlønn/sluttvederlag, er i utdanningspermisjon, eller du har startet i nytt arbeidsforhold uten å ha ny opptjening til sykepenger.',
    ...
    {
        'displayName': 'Sickness benefit - international, other documentation - NAV 00-03.00',
        'description': 'Select this "form" for submitting sickness benefit documentation (international). Here you can also choose complaint / appeal for cases concerning sickness benefits (international).',
        'url': 'https://www.nav.no/soknader/en/person/helse/sykepenger#NAV000300',
        'language': 'en',
    },
    {
        'displayName': 'Sykepenger - utland, annen dokumentasjon - NAV 00-03.00',
        'description': 'Velg dette "skjemaet" for innsending av dokumentasjon som gjelder sykepenger (utland). Her kan du også velge klage/anke for saker som gjelder sykepenger (utland).',
        'url': 'https://www.nav.no/soknader/nb/person/helse/sykepenger#NAV000300',
        'language': 'nb',
    },
    {
        'displayName': 'Sickness benefit - claims and income information - NAV 00-03.00',
        'description': 'Select this "form" for submitting documentation for which there are no forms. Here you can also choose complaint / appeal for cases concerning sickness benefits.\n\nThe documentation should be sent to the NAV Arbeid og ytelser unit serving your county.',
        'url': 'https://www.nav.no/soknader/en/person/helse/sykepenger#NAV000300',
        'language': 'en',
    },
    {
        'displayName': 'Sykepenger - krav og inntektsopplysninger - NAV 00-03.00',
        'description': 'Velg dette "skjemaet" for innsending av dokumentasjon som det ikke finnes skjemaer for. Her kan du også velge klage/anke for saker som gjelder sykepenger.\n\nDokumentasjonen skal sendes til NAV Arbeid og ytelser for det fylket du bor i.',
        'url': 'https://www.nav.no/soknader/nb/person/helse/sykepenger#NAV000300',
        'language': 'nb',
    },
    {
        'displayName': 'Sickness benefit - other documentation - NAV 00-03.00',
        'description': 'Select this "form" for submitting sickness benefit documentation. Here you can also choose complaint / appeal for cases concerning sickness benefits.',
        'url': 'https://www.nav.no/soknader/en/person/helse/sykepenger#NAV000300',
        'language': 'en',
    },
    {
        'displayName': 'Sykepenger - annen dokumentasjon - NAV 00-03.00',
        'description': 'Velg dette "skjemaet" for innsending av dokumentasjon som gjelder sykepenger. Her kan du også velge klage/anke for saker som gjelder sykepenger.\n\nDokumentene skal sendes til NAV-kontoret du tilhører. På Ditt NAV ser du hvilket NAV-kontor du tilhører. Hvis du ikke kan logge inn, ring 55 55 33 33.',
        'url': 'https://www.nav.no/soknader/nb/person/helse/sykepenger#NAV000300',
        'language': 'nb',
    },
    {
    ...
    },
    {
        ...
        'description': 'If your earning ability (ability to obtain income from work) is permanently reduced due to illness or injury, you may be entitled to disability benefits. It must be clarified with NAV that you are not able to be at work before applying for disability benefits.',
        'url': 'https://www.nav.no/soknader/en/person/helse/uforetrygd#NAV120605',
        'language': 'en',
    },
    {
        'displayName': 'Søknad om uføretrygd - NAV 12-06.05',
        'description': 'Du kan ha rett til uføretrygd hvis du har en varig nedsatt inntektsevne på grunn av sykdom eller skade. Før du søker må du har fått avklart med NAV at du ikke kan være i arbeid.\n\nHvis du er delvis i arbeid må du legge ved tilleggsskjema til søknaden din. Dette gjelder også om du ønsker å søke om barnetillegg.\n\nSøker du uføretrygd og har bodd i utlandet eller har barn under 18 år, må du sende søknaden i posten ved å klikke lenken "Jeg har ikke elektronisk ID". Alle kan melde fra elektronisk om inntektsendring knyttet til uføretrygd - med og uten barnetillegg."',
        'url': 'https://www.nav.no/soknader/nb/person/helse/uforetrygd#NAV120605',
        'language': 'nb',
    },
    {
        'displayName': 'Form for income change - for those who have disability benefits - NAV 12-14.01',
    ...
    },
    {
        ...
        'description': 'Når du ikke har barnetillegg, bruker du dette skjemaet for å melde fra om endringer i inntekten som kan ha betydning for uføretrygden din.',
    ...
    },
    {
        ...
        'description': 'If you have applied for or are receiving disability benefits and you support spouse and/or children, you may apply for child supplement when the family has a combined income below a certain level.',
    ...
    },
    {
        ...
        'description': 'Du kan søke om barnetillegg til uføretrygden hvis du forsørger barn under 18 år. Barnetillegget blir behovsprøvd ut fra begge foreldrenes inntekt. Hvis du ikke bor sammen med den andre forelderen til barnet, blir barnetillegget behovsprøvd ut fra inntekten din.',
