...
if (app.config.env !== 'test') {
    ...
    // TODO fjern kommentering av createLegacyOfficeImportSchedule() etter at vi har satt opp redirects og fjernet kontorer fra enhetNrToImport i legacy-office-update.ts
