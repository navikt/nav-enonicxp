...
var view = resolve('createpropertiesxmlformigration.html');
 ...
 * The following DataSources were used in the original CMS page template:
 ...
 <datasources>
    <datasource name="getContentByCategory">
      <parameter name="categoryKeys">${select(param.categoryKey,6394)}</parameter>
      <parameter name="levels">0</parameter>
      <parameter name="query"/>
      <parameter name="orderBy">key ASC</parameter>
