...
exports.get = function (req) {
   return cache.getPaths('transport' + req.path, function () {
        ...
        var model = {
            ...
            items: items.map(function (value) {
                return {
                    ...
                    logo: portal.attachmentUrl({id: value.logo}),
        ...
        return {
            ...
            pageContributions: {
                headEnd: [
                    '<link rel="stylesheet" href="' + portal.assetUrl({path: 'styles/css/navno.css'}) + '"/>'
                ]
            }
        }
    })
...
function getUrl(url) {
    ...
    return portal.pageUrl({id: url.ref});
}