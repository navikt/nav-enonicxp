...
var view = resolve('skjemaveileder-ettersendelsearbeidsgiver-formgenerator.html');

function handleGet(req) {

    var params = {
        partName: "skjemaveileder-ettersendelsearbeidsgiver-formgenerator"
    };
...
<datasources>
    ...
    <datasource name="getContentBySection" result-element="schematext_arbeidsgiver">
      <parameter name="menuItemKeys">${select(param.id, '-1')}</parameter>
      <parameter name="levels">0</parameter>
