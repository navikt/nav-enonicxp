...
import { directLocalFetch, fetchXp } from '../lib/xp-http.mjs';
import { getLocalProcessEnvironment } from '../lib/local-xp-target.mjs';
...
test(
    ...
    async (t) => {
        ...
        const code = `
        import { getXpSessionCookie } from ${JSON.stringify(new URL('../lib/xp-auth.mjs', import.meta.url).href)};
        import { directLocalFetch } from ${JSON.stringify(new URL('../lib/xp-http.mjs', import.meta.url).href)};
